...
export function Contact() {
  ...
  const inputClass =
    'w-full bg-white/[0.04] border border-white/10 rounded-xl px-4 py-3 text-white/80 text-sm placeholder:text-white/25 focus:outline-none focus:border-[#4e7eff]/60 focus:bg-white/[0.07] focus:shadow-[0_0_20px_rgba(78,126,255,0.1)] transition-all duration-200'
    ...
    <section id="contact" className="py-28" aria-labelledby="contact-heading">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <FadeIn delay={120}>
            {submitted ? (
              <div className="glass-card flex flex-col items-start justify-center h-64 p-8 rounded-2xl border border-emerald-500/20 bg-emerald-500/[0.03]">
              ...
              <div className="glass-card rounded-2xl p-8">
                <form onSubmit={handleSubmit} noValidate aria-label="Contact form">
                  <div className="space-y-4">
                    ...
                    <button
                      type="submit"
                      className="w-full px-6 py-3.5 rounded-full border border-[#4e7eff]/50 bg-[#4e7eff]/10 text-white text-sm font-medium hover:bg-[#4e7eff]/25 hover:border-[#4e7eff]/80 shadow-[0_0_30px_rgba(78,126,255,0.15)] hover:shadow-[0_0_40px_rgba(78,126,255,0.3)] transition-all duration-200 flex items-center justify-center gap-2"
                    >
                      Send via WhatsApp
